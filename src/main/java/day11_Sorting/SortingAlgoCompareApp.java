...
public class SortingAlgoCompareApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("QuickSort run in " + (end - start) + " milliseconds" + " with data set.");
        ...
        System.out.println("InsertionSort runs in " + (end - start) + " milliseconds" + "with the same data set.");
        ...
        System.out.println("BubbleSort runs in " + (end - start) + " milliseconds" + "with the same data set.");
        ...
        System.out.println("MergeSort runs in " + (end - start) + " milliseconds" + "with the same data set.");
        ...
        System.out.println("SelectionSort runs in " + (end - start) + " milliseconds" + "with the same data set.");
    }
}
